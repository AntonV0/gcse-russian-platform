...
with upserted_set as (
  ...
  values (
    'high-frequency-language-ordinal-numbers',
    'Ordinal numbers',
    'Spec-required high-frequency GCSE Russian ordinal numbers from Section 1: High-frequency language.',
    ...
    'pearson_edexcel_gcse_russian_1ru0',
    '1RU0',
    'section-1:high-frequency-language:ordinal-numbers'
  )
...
upserted_list as (
  ...
  select
    ...
    'ordinal-numbers',
    'Ordinal numbers',
    'Spec-required high-frequency GCSE Russian ordinal numbers.',
    'high_frequency_language',
    'ordinal_numbers',
    'ordinal_numbers',
    'both',
    ...
    '1RU0',
    'Section 1: High-frequency language / Ordinal numbers',
    'section-1:high-frequency-language:ordinal-numbers:list'
  from upserted_set
  on conflict (source_key, import_key)
  where source_key is not null and import_key is not null
  do update
...
raw_items (
  ...
  values
    (1, $$first$$, $$первый$$, $$первый$$),
    (2, $$second$$, $$второй$$, $$второй$$),
    (3, $$third$$, $$третий$$, $$третий$$),
    (4, $$fourth$$, $$четвёртый$$, $$четвёртый$$),
    (5, $$fifth$$, $$пятый$$, $$пятый$$),
    (6, $$sixth$$, $$шестой$$, $$шестой$$),
    (7, $$seventh$$, $$седьмой$$, $$седьмой$$),
    (8, $$eight$$, $$восьмой$$, $$восьмой$$),
    (9, $$ninth$$, $$девятый$$, $$девятый$$),
    (10, $$tenth$$, $$десятый$$, $$десятый$$),
    (11, $$eleventh$$, $$одиннадцатый$$, $$одиннадцатый$$),
    (12, $$twelfth$$, $$двенадцатый$$, $$двенадцатый$$),
    (13, $$twenty first$$, $$двадцать первый$$, $$двадцать первый$$)
),
prepared_items as (
  select
    raw_items.position,
    ...
    (
      'section-1:high-frequency-language:ordinal-numbers:item-' ||

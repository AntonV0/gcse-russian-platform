...
with upserted_set as (
  ...
  values (
    'high-frequency-language-connecting-words',
    'Some useful connecting words',
    'Spec-required high-frequency GCSE Russian connecting words from Section 1: High-frequency language.',
    ...
    'pearson_edexcel_gcse_russian_1ru0',
    '1RU0',
    'section-1:high-frequency-language:connecting-words'
  )
...
upserted_list as (
  ...
  select
    ...
    'connecting-words',
    'Some useful connecting words',
    'Spec-required high-frequency GCSE Russian connecting words.',
    'high_frequency_language',
    'connecting_words',
    'connecting_words',
    'both',
    ...
    'pearson_edexcel_gcse_russian_1ru0',
    '1RU0',
    'Section 1: High-frequency language / Some useful connecting words',
    'section-1:high-frequency-language:connecting-words:list'
  from upserted_set
  on conflict (source_key, import_key)
  where source_key is not null and import_key is not null
  do update
...
raw_items (
  ...
  values
    (1, $$also$$, $$также$$, $$также$$, 'adverb'),
    (2, $$although$$, $$хотя$$, $$хотя$$, 'conjunction'),
    (3, $$and$$, $$и$$, $$и$$, 'conjunction'),
    (4, $$as, since$$, $$так как$$, $$так, как$$, 'conjunction'),
    (5, $$because$$, $$потому что$$, $$потому что$$, 'conjunction'),
    (6, $$because of$$, $$из-за$$, $$из-за$$, 'preposition'),
    (7, $$but$$, $$но$$, $$но$$, 'conjunction'),
    (8, $$even$$, $$даже$$, $$даже$$, 'adverb'),
    (9, $$finally$$, $$наконец$$, $$наконец$$, 'adverb'),
    (10, $$first of all$$, $$прежде всего$$, $$прежде всего$$, 'adverb'),
    (11, $$however$$, $$однако$$, $$однако$$, 'adverb'),
    (12, $$if$$, $$если$$, $$если$$, 'conjunction'),
    (13, $$in order to$$, $$чтобы$$, $$чтобы$$, 'conjunction'),
    (14, $$in short$$, $$короче говоря$$, $$короче говоря$$, 'adverb'),
    (15, $$it is obvious$$, $$очевидно$$, $$очевидно$$, 'adverb'),
    (16, $$moreover$$, $$к тому же$$, $$к тому же$$, 'adverb'),
    (17, $$neither... nor...$$, $$ни ... ни ...$$, $$ни.... ни ....$$, 'conjunction'),
    (18, $$or$$, $$или$$, $$или$$, 'conjunction'),
    (19, $$perhaps$$, $$возможно$$, $$возможно$$, 'adverb'),
    (20, $$so$$, $$итак / так$$, $$итак, так$$, 'adverb'),
    (21, $$then$$, $$тогда$$, $$тогда$$, 'adverb'),
    (22, $$then, next$$, $$потом$$, $$потом$$, 'adverb'),
    (23, $$therefore$$, $$поэтому$$, $$поэтому$$, 'adverb'),
    (24, $$this is, here is$$, $$это$$, $$это$$, 'pronoun'),
    (25, $$whether$$, $$ли$$, $$ли$$, 'conjunction')
),
prepared_items as (
  select
    raw_items.position,
    ...
    (
      'section-1:high-frequency-language:connecting-words:item-' ||

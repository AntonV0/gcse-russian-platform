...
with upserted_set as (
  ...
  values (
    'high-frequency-language-other-high-frequency-words',
    'Other high-frequency words',
    'Spec-required high-frequency GCSE Russian words from Section 1: High-frequency language.',
    'high_frequency_language',
    'other_high_frequency_words',
    'both',
    'spec_only',
    'specification',
    'single_column',
    ...
    'pearson_edexcel_gcse_russian_1ru0',
    '1RU0',
    'section-1:high-frequency-language:other-high-frequency-words'
  )
...
upserted_list as (
  ...
  select
    ...
    'other-high-frequency-words',
    'Other high-frequency words',
    'Spec-required high-frequency GCSE Russian words.',
    'high_frequency_language',
    'other_high_frequency_words',
    'other_high_frequency_words',
    'both',
    ...
    '1RU0',
    'Section 1: High-frequency language / Other high-frequency words',
    'section-1:high-frequency-language:other-high-frequency-words:list'
  from upserted_set
  on conflict (source_key, import_key)
  where source_key is not null and import_key is not null
  do update
...
raw_items (
  ...
  values
    (1, $$apart from$$, $$кроме$$, $$кроме$$, 'preposition', 'not_applicable'),
    (2, $$as, like$$, $$как$$, $$как$$, 'conjunction', 'not_applicable'),
    (3, $$end$$, $$конец$$, $$конец$$, 'noun', 'masculine'),
    (4, $$everybody$$, $$все$$, $$все$$, 'pronoun', 'not_applicable'),
    (5, $$everything$$, $$всё$$, $$всё$$, 'pronoun', 'not_applicable'),
    (6, $$except$$, $$кроме$$, $$кроме$$, 'preposition', 'not_applicable'),
    (7, $$figure (number)$$, $$цифра$$, $$цифра$$, 'noun', 'feminine'),
    (8, $$for example$$, $$например$$, $$например$$, 'adverb', 'not_applicable'),
    (9, $$Miss$$, $$госпожа$$, $$госпожа$$, 'noun', 'feminine'),
    (10, $$Mr (also Sir)$$, $$господин$$, $$господин$$, 'noun', 'masculine'),
    (11, $$Mrs (also Madam)$$, $$госпожа$$, $$госпожа$$, 'noun', 'feminine'),
    (12, $$number$$, $$число$$, $$число$$, 'noun', 'neuter'),
    (13, $$number (e.g. phone number)$$, $$номер$$, $$номер$$, 'noun', 'masculine'),
    (14, $$opinion$$, $$мнение$$, $$мнение$$, 'noun', 'neuter'),
    (15, $$reason$$, $$причина$$, $$причина$$, 'noun', 'feminine'),
    (16, $$someone$$, $$кто-то / кто-нибудь$$, $$кто-то, кто-нибудь$$, 'pronoun', 'not_applicable'),
    (17, $$something$$, $$что-то / что-нибудь$$, $$что-то, что-нибудь$$, 'pronoun', 'not_applicable'),
    (18, $$that$$, $$то$$, $$то$$, 'pronoun', 'not_applicable'),
    (19, $$thing$$, $$что-то$$, $$что-то$$, 'pronoun', 'not_applicable'),
    (20, $$time (occasion)$$, $$раз / случай$$, $$раз, случай$$, 'noun', 'masculine'),
    (21, $$type (kind of)$$, $$вид / тип$$, $$вид, тип$$, 'noun', 'masculine'),
    (22, $$with$$, $$с$$, $$с$$, 'preposition', 'not_applicable'),
    (23, $$without$$, $$без$$, $$без$$, 'preposition', 'not_applicable')
),
prepared_items as (
  select
    raw_items.position,
    ...
    (
      'section-1:high-frequency-language:other-high-frequency-words:item-' ||

...
upserted_list as (
  ...
  select
    ...
    'foundation',
    'Foundation tier',
    'Foundation tier vocabulary for dealing with problems.',
    'local_area_holiday_travel',
    'local_area_holiday_travel_problems',
    ...
    'pearson_edexcel_gcse_russian_1ru0',
    '1RU0',
    'Section 2: Topic-specific vocabulary / Local area, holiday and travel / Dealing with problems / Foundation tier',
    'section-2:local-area-holiday-and-travel:dealing-with-problems:foundation:list'
  from upserted_set
  on conflict (source_key, import_key)
  where source_key is not null and import_key is not null
  do update
...
raw_items (
  ...
  values
    (1, $$address$$, $$адрес$$, $$адрес$$, 'noun', 'masculine', 'not_applicable', false),
    (2, $$bill$$, $$счёт$$, $$счёт$$, 'noun', 'masculine', 'not_applicable', false),
    (3, $$colour$$, $$цвет$$, $$цвет$$, 'noun', 'masculine', 'not_applicable', false),
    (4, $$correct$$, $$правильный$$, $$правильный$$, 'adjective', 'not_applicable', 'not_applicable', false),
    (5, $$customer$$, $$клиент$$, $$клиент$$, 'noun', 'masculine', 'not_applicable', false),
    (6, $$customer service$$, $$сервис$$, $$сервис$$, 'noun', 'masculine', 'not_applicable', false),
    (7, $$email address$$, $$электронный адрес$$, $$электронный адрес$$, 'noun', 'masculine', 'not_applicable', false),
    (8, $$form$$, $$бланк$$, $$бланк$$, 'noun', 'masculine', 'not_applicable', false),
    (9, $$guarantee$$, $$гарантия$$, $$гарантия$$, 'noun', 'feminine', 'not_applicable', false),
    (10, $$part$$, $$часть$$, $$часть$$, 'noun', 'feminine', 'not_applicable', false),
    (11, $$purse$$, $$кошелёк$$, $$кошелёк$$, 'noun', 'masculine', 'not_applicable', false),
    (12, $$receipt$$, $$чек$$, $$чек$$, 'noun', 'masculine', 'not_applicable', false),
    (13, $$size$$, $$размер$$, $$размер$$, 'noun', 'masculine', 'not_applicable', false),
    (14, $$telephone number$$, $$номер телефона$$, $$номер телефона$$, 'noun', 'masculine', 'not_applicable', false),
    (15, $$to pay$$, $$платить / заплатить$$, $$платить/за-$$, 'verb', 'not_applicable', 'both', false),
    (16, $$to work, function$$, $$работать$$, $$работать$$, 'verb', 'not_applicable', 'imperfective', false),
    (17, $$wrong$$, $$неправильный$$, $$неправильный$$, 'adjective', 'not_applicable', 'not_applicable', false)
),
prepared_items as (
  select
    raw_items.position,
    ...
    (
      'dealing-with-problems-foundation:item-' ||

...
with upserted_set as (
  ...
  values (
    'high-frequency-language-days-of-the-week',
    'Days of the week',
    'Spec-required high-frequency GCSE Russian days of the week from Section 1: High-frequency language.',
    ...
    'pearson_edexcel_gcse_russian_1ru0',
    '1RU0',
    'section-1:high-frequency-language:days-of-the-week'
  )
...
upserted_list as (
  ...
  select
    ...
    'days-of-the-week',
    'Days of the week',
    'Spec-required high-frequency GCSE Russian days of the week.',
    'high_frequency_language',
    'days_of_the_week',
    'days_of_the_week',
    'both',
    ...
    '1RU0',
    'Section 1: High-frequency language / Days of the week',
    'section-1:high-frequency-language:days-of-the-week:list'
  from upserted_set
  on conflict (source_key, import_key)
  where source_key is not null and import_key is not null
  do update
...
raw_items (
  ...
  values
    (1, $$Monday$$, $$понедельник$$, $$понедельник$$, 'noun', 'masculine'),
    (2, $$Tuesday$$, $$вторник$$, $$вторник$$, 'noun', 'masculine'),
    (3, $$Wednesday$$, $$среда$$, $$среда$$, 'noun', 'feminine'),
    (4, $$Thursday$$, $$четверг$$, $$четверг$$, 'noun', 'masculine'),
    (5, $$Friday$$, $$пятница$$, $$пятница$$, 'noun', 'feminine'),
    (6, $$Saturday$$, $$суббота$$, $$суббота$$, 'noun', 'feminine'),
    (7, $$Sunday$$, $$воскресенье$$, $$воскресенье$$, 'noun', 'neuter'),
    (8, $$(on) Monday$$, $$в понедельник$$, $$в понедельник$$, 'adverb', 'not_applicable'),
    (9, $$(on) Monday morning$$, $$в понедельник утром$$, $$в понедельник утром$$, 'adverb', 'not_applicable'),
    (10, $$(on) Monday evening$$, $$в понедельник вечером$$, $$в понедельник вечером$$, 'adverb', 'not_applicable'),
    (11, $$on Mondays$$, $$по понедельникам$$, $$по понедельникам$$, 'adverb', 'not_applicable'),
    (12, $$every Monday$$, $$каждый понедельник$$, $$каждый понедельник$$, 'adverb', 'not_applicable')
),
prepared_items as (
  select
    raw_items.position,
    ...
    (
      'section-1:high-frequency-language:days-of-the-week:item-' ||

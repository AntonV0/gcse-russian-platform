...
with upserted_set as (
  ...
  values (
    'high-frequency-language-prepositions',
    'Prepositions',
    'Spec-required high-frequency GCSE Russian prepositions from Section 1: High-frequency language.',
    ...
    'pearson_edexcel_gcse_russian_1ru0',
    '1RU0',
    'section-1:high-frequency-language:prepositions'
  )
...
upserted_list as (
  ...
  select
    ...
    'prepositions',
    'Prepositions',
    'Spec-required high-frequency GCSE Russian prepositions.',
    'high_frequency_language',
    'prepositions',
    'prepositions',
    'both',
    ...
    '1RU0',
    'Section 1: High-frequency language / Prepositions',
    'section-1:high-frequency-language:prepositions:list'
  from upserted_set
  on conflict (source_key, import_key)
  where source_key is not null and import_key is not null
  do update
...
raw_items (
  ...
  values
    (1, $$about$$, $$о$$, $$о$$),
    (2, $$after$$, $$после$$, $$после$$),
    (3, $$among$$, $$среди / между$$, $$среди, между$$),
    (4, $$around$$, $$вокруг$$, $$вокруг$$),
    (5, $$at$$, $$в / на$$, $$в, на$$),
    (6, $$at (someone’s house)$$, $$у$$, $$у$$),
    (7, $$at the back$$, $$сзади$$, $$сзади$$),
    (8, $$because of$$, $$из-за$$, $$из-за$$),
    (9, $$before$$, $$до$$, $$до$$),
    (10, $$behind$$, $$за$$, $$за$$),
    (11, $$between$$, $$между$$, $$между$$),
    (12, $$far from$$, $$далеко от$$, $$далеко от$$),
    (13, $$from$$, $$от$$, $$от$$),
    (14, $$in$$, $$в$$, $$в$$),
    (15, $$in front of$$, $$перед$$, $$перед$$),
    (16, $$in the background$$, $$на заднем плане$$, $$на заднем плане$$),
    (17, $$in the foreground$$, $$на переднем плане$$, $$на переднем плане$$),
    (18, $$in the middle (of)$$, $$среди$$, $$среди$$),
    (19, $$near (to)$$, $$около$$, $$около$$),
    (20, $$near (to)$$, $$близко от$$, $$близко от$$),
    (21, $$next to$$, $$рядом с$$, $$рядом с$$),
    (22, $$on$$, $$на$$, $$на$$),
    (23, $$onto$$, $$на$$, $$на$$),
    (24, $$opposite$$, $$напротив$$, $$напротив$$),
    (25, $$outside$$, $$снаружи$$, $$снаружи$$),
    (26, $$through$$, $$через$$, $$через$$),
    (27, $$to$$, $$в / на$$, $$в, на$$),
    (28, $$towards$$, $$к$$, $$к$$),
    (29, $$under$$, $$под$$, $$под$$),
    (30, $$until$$, $$до$$, $$до$$),
...
prepared_items as (
  select
    ...
    (
      'section-1:high-frequency-language:prepositions:item-' ||

        ...
        <div className="space-y-8 py-8 md:py-12">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="app-header-block">
                      ...
                      <p className="app-subtitle max-w-2xl">
                        ...
                        Russian (1RU0), combining structured lessons, exam-focused
                        practice, and progress tracking for Foundation and Higher
                        students.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mb-4 flex items-start justify-between gap-4">
                    <div className="min-w-0">
                      ...
                      <p className="mt-1 text-sm app-text-muted">
                        Designed to support both independent study and teacher-led
                        learning.
                      </p>
                    </div>
            ...
            <section>
              <div className="mb-4">
                ...
                <p className="mt-1 text-sm app-text-muted">
                  Designed to support GCSE Russian students and families at every stage
                  of preparation.
                </p>
              </div>

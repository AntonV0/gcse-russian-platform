  ...
  return (
    <main className="space-y-4">
      ...
      <FeedbackBanner
        ...
        description={
          isDraft
            ? `${savedResponseCount} of ${questionCount} responses saved. ${reviewCue} Save draft responses while you work, then submit when you are ready for marking.`
            : attempt.status === "marked"
              ? `This attempt has been marked. ${reviewCue}`
              : `This attempt has been submitted. ${reviewCue}`
        }
      />
        ...
        >
          <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.6fr)]">
            <div className="rounded-2xl border border-[var(--border)] bg-[var(--background-muted)] p-5">
              <div className="text-xs font-semibold uppercase tracking-[0.12em] app-text-soft">
                {attempt.status === "marked" ? "Awarded score" : "Provisional auto-mark"}
              </div>
              ...
              {scorePercent !== null ? (
                <div className="mt-5">
                  ...
                  >
                    <div
                      className="app-progress-bar app-progress-bar-success"
                  ...
                  <div className="mt-2 text-sm font-medium text-[var(--text-secondary)]">
                    {attempt.status === "marked"
                      ...
                      : `${scorePercent}% currently auto-marked. Teacher review may change the final result.`}
                  </div>
                </div>
              ) : (
      ...
      >
        <div className="grid gap-3 md:grid-cols-3">
          ...
          <div className="rounded-xl border border-[var(--border)] bg-[var(--background-muted)] px-4 py-3">
            <div className="text-xs font-semibold uppercase tracking-[0.12em] app-text-soft">
              {attempt.status === "marked" ? "Score" : "Provisional score"}
            </div>
            <div className="mt-1 text-sm text-[var(--text-primary)]">

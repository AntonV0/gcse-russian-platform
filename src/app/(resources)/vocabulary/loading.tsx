  ...
  return (
    <main className="space-y-4">
      <section className="app-intro-panel app-intro-panel-student px-5 py-5 md:px-6 md:py-6">
        <div className="h-4 w-28 rounded-full bg-[var(--background-muted)]" />
      ...
      <section className="app-section-card rounded-2xl p-5">
        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-[minmax(220px,1fr)_160px_170px_170px_max-content]">

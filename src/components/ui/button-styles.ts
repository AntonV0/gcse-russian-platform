  ...
  switch (variant) {
    case "primary":
      return [
        ...
        "shadow-[inset_0_0_0_1px_color-mix(in_srgb,var(--brand-white)_14%,transparent),0_10px_22px_color-mix(in_srgb,var(--accent)_18%,transparent),0_2px_6px_color-mix(in_srgb,var(--accent)_10%,transparent)]",
        disabled
          ? "opacity-60"
          : [
              ...
              "hover:saturate-[1.02]",
              "hover:shadow-[inset_0_0_0_1px_color-mix(in_srgb,var(--brand-white)_16%,transparent),0_14px_30px_color-mix(in_srgb,var(--accent)_22%,transparent),0_4px_10px_color-mix(in_srgb,var(--accent)_12%,transparent)]",
            ].join(" "),
      ].join(" ");
      ...
      return [
        ...
        disabled
          ...
          : [
              ...
              "hover:border-[color-mix(in_srgb,var(--accent-border-ink)_28%,transparent)]",
    ...
    case "soft":
      return [
        ...
        "border border-[color-mix(in_srgb,var(--accent-border-ink)_28%,transparent)]",
        ...
        disabled
          ...
          : [
              ...
              "hover:border-[color-mix(in_srgb,var(--accent-border-ink)_44%,transparent)]",
    ...
    case "accent":
      return [
        ...
        "shadow-[inset_0_0_0_1px_color-mix(in_srgb,var(--brand-white)_14%,transparent),0_11px_25px_color-mix(in_srgb,var(--accent)_22%,transparent),0_2px_7px_color-mix(in_srgb,var(--accent)_13%,transparent)]",
        disabled
          ? "opacity-60"
          : [
              ...
              "hover:saturate-[1.04]",
              "hover:shadow-[inset_0_0_0_1px_color-mix(in_srgb,var(--brand-white)_16%,transparent),0_16px_34px_color-mix(in_srgb,var(--accent)_28%,transparent),0_4px_11px_color-mix(in_srgb,var(--accent)_16%,transparent)]",
            ].join(" "),
      ].join(" ");
    ...
    case "inverse":
      return [
        ...
        "[html[data-theme=dark]_&]:border-[color-mix(in_srgb,var(--accent-border-ink)_46%,var(--dark-surface-border))]",
        ...
        "[html[data-theme=dark]_&]:shadow-[0_1px_2px_rgba(0,0,0,0.24),0_0_0_1px_color-mix(in_srgb,var(--accent-border-ink)_26%,transparent),0_13px_30px_color-mix(in_srgb,var(--accent)_10%,transparent)]",
        ...
        disabled
          ...
          : [
              ...
              "[html[data-theme=dark]_&]:hover:border-[color-mix(in_srgb,var(--accent-border-ink)_58%,var(--dark-surface-border))]",
              ...
              "[html[data-theme=dark]_&]:hover:shadow-[0_1px_2px_rgba(0,0,0,0.26),0_0_0_1px_color-mix(in_srgb,var(--accent-border-ink)_34%,transparent),0_17px_36px_color-mix(in_srgb,var(--accent)_15%,transparent)]",
            ].join(" "),
      ].join(" ");
...
function getSizeClass(size: ButtonSize, iconOnly: boolean) {
  if (iconOnly) {
    return size === "sm"
      ? "h-10 w-10 rounded-[var(--radius-control)] p-0"
      : "h-11 w-11 rounded-[var(--radius-lg)] p-0";
  }

  return size === "sm"
    ? "min-h-10 rounded-[var(--radius-control)] px-3.5 py-2 text-sm"
    : "min-h-11 rounded-[var(--radius-control)] px-4.5 py-2.5 text-sm";
}
...
function getInteractionShadowClass(
  ...
  if (interaction === "flat") {
    switch (variant) {
      case "primary":
      case "accent":
        return "hover:shadow-[inset_0_0_0_1px_color-mix(in_srgb,var(--brand-white)_14%,transparent),0_7px_16px_color-mix(in_srgb,var(--accent)_15%,transparent),0_1px_4px_color-mix(in_srgb,var(--accent)_8%,transparent)]";
      case "journey":
        return "hover:shadow-[0_7px_16px_color-mix(in_srgb,var(--accent)_15%,transparent),0_1px_4px_color-mix(in_srgb,var(--accent)_8%,transparent)]";
      case "inverse":
        return "hover:shadow-[inset_0_1px_0_color-mix(in_srgb,var(--brand-white)_8%,transparent),0_8px_18px_color-mix(in_srgb,var(--text-primary)_18%,transparent),0_1px_4px_color-mix(in_srgb,var(--text-primary)_8%,transparent)] [html[data-theme=dark]_&]:hover:shadow-[0_1px_2px_rgba(0,0,0,0.22),0_0_0_1px_color-mix(in_srgb,var(--accent-border-ink)_28%,transparent),0_8px_18px_color-mix(in_srgb,var(--accent)_9%,transparent)]";
      case "danger":
      case "exit":
  ...
  switch (variant) {
    case "primary":
    case "accent":
      return "hover:shadow-[inset_0_0_0_1px_color-mix(in_srgb,var(--brand-white)_15%,transparent),0_11px_24px_color-mix(in_srgb,var(--accent)_20%,transparent),0_3px_8px_color-mix(in_srgb,var(--accent)_11%,transparent)]";
    case "inverse":
      return "hover:shadow-[inset_0_1px_0_color-mix(in_srgb,var(--brand-white)_10%,transparent),0_12px_25px_color-mix(in_srgb,var(--text-primary)_24%,transparent),0_3px_8px_color-mix(in_srgb,var(--text-primary)_11%,transparent)] [html[data-theme=dark]_&]:hover:shadow-[0_1px_2px_rgba(0,0,0,0.24),0_0_0_1px_color-mix(in_srgb,var(--accent-border-ink)_32%,transparent),0_12px_26px_color-mix(in_srgb,var(--accent)_12%,transparent)]";
    case "success":

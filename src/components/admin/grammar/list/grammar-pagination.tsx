...
function buildPageHref(params: AdminGrammarSearchParams, page: number) {
  ...
  return `/admin/grammar${queryString ? `?${queryString}` : ""}`;
}
...
export default function GrammarPagination({
  ...
  return (
    <nav
      ...
      aria-label="Grammar set pagination"
    >

      ...
      <div className="grid gap-4 xl:grid-cols-3">
        <Card>
          <CardBody className="space-y-3">
            ...
            <p className="text-sm app-text-muted">
              Use as the default repeated surface for summaries, dashboard items, content
              previews, and compact grouped information.
            </p>
        ...
        >
          <div className="space-y-3">
            <p className="text-sm app-text-muted">
              Best when a section needs a visible heading and description before a body of
              controls, actions, or structured content.
            </p>
      ...
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_minmax(300px,0.8fr)]">
        ...
        >
          <div className="space-y-3 text-sm app-text-muted">
            <p>
              Use a header when status, title, or context must remain visually tied to the
              card.
            </p>
            <p>

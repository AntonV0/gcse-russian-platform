import { LESSON_CONTENT_FUTURE_ITEMS } from "@/components/admin/ui-lab/lesson-content/ui-lab-lesson-content-data";
          ...
          <Card>
            <CardBody className="p-4">
              ...
              <p className="mt-2 text-sm app-text-muted">
                ÐœÐ½Ðµ Ð½Ñ€Ð°Ð²Ð¸Ñ‚ÑÑ Ð¼Ð°Ñ‚ÐµÐ¼Ð°Ñ‚Ð¸ÐºÐ°, Ð¿Ð¾Ñ‚Ð¾Ð¼Ñƒ Ñ‡Ñ‚Ð¾ Ð¾Ð½Ð°
                Ð¿Ð¾Ð»ÐµÐ·Ð½Ð°Ñ.
              </p>
            </CardBody>
          </Card>

...
import UiLabLessonBuilderPrimitivesDemo from "@/components/admin/ui-lab/lesson-builder/ui-lab-lesson-builder-primitives-demo";
import UiLabSection from "@/components/admin/ui-lab/shell/ui-lab-section";
import {
  BlockRow,
  SectionSidebarRow,
  lessonBuilderBlockTypeGroups,
} from "@/components/admin/ui-lab/lesson-builder/ui-lab-lesson-builder-demo-primitives";
...
export const LESSON_BUILDER_PAGE_NAV_ITEMS = [
...
export default function UiLabLessonBuilderSections() {
  return (
    <>
      <UiLabSection
        id="workspace-shell"
        ...
        <div className="grid gap-4 xl:grid-cols-[minmax(0,1.1fr)_minmax(320px,0.9fr)]">
          <SectionCard title="Choose a block type" tone="admin" density="compact">
            <div className="space-y-5">
              {lessonBuilderBlockTypeGroups.map(([group, items]) => (
                <div key={group}>
